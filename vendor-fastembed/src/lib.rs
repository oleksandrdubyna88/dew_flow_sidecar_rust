...
// VENDORED ADDITION (clauderag): both BGE-M3 heads from one session/run — see the module docs.
mod bgem3_dual;
mod bgem3_embedding;
...
pub use crate::bgem3_dual::{Bgem3DualEmbedding, Bgem3DualInitOptions};
